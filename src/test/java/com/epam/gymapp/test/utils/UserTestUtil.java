...
public class UserTestUtil {
  ...
  public static String getUserToken() {
    return JwtTokenTestUtil.generateToken(new HashMap<>(), getTraineeUser1());
  }
  ...
  public static UserCredentialsDto getTraineeUserCredentialsDto1() {
    return UserCredentialsDto.builder()
        ...
        .token(JwtTokenTestUtil.generateToken(new HashMap<>(), getTraineeUser1()))
        .build();
  }
  ...
  public static UserCredentialsDto getTrainerUserCredentialsDto1() {
    return UserCredentialsDto.builder()
        ...
        .token(JwtTokenTestUtil.generateToken(new HashMap<>(), getTrainerUser1()))
        .build();
  }
